...
class HomePage extends Component {
    constructor(props){
        ...
        this.state = {
            cart: {
                ...
                cartItems: JSON.parse(localStorage.getItem("cartItems")) || 0,
    ...
    updateLocalStorage(){
        ...
        localStorage.setItem("cart", JSON.stringify(this.state.cart.cartArray));
        localStorage.setItem("cartItems", JSON.stringify(this.state.cart.cartItems));
        localStorage.setItem("cartTotal", JSON.stringify(this.state.cart.cartTotal));
    }
